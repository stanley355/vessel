      ...
      <div className={styles.subscription__slug}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.form__field}>
            ...
            <select name="subscription_duration" id="subscription_duration" onChange={(e:any) => setSubsDuration(e.target.value) } defaultValue="1">
          ...
          <button type="submit" className={styles.form__cta}>Submit</button>
        </form>
      </div>
    </div>
  )
